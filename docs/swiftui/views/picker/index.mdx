...
您可以使用符合 [PickerStyle](https://developer.apple.com/documentation/swiftui/pickerstyle) 协议的样式（如 [segmented](https://developer.apple.com/documentation/swiftui/pickerstyle/segmented) 或 [menu](https://developer.apple.com/documentation/swiftui/pickerstyle/menu) ）自定义选取器的外观和交互：
