...
<OriginalLink
  title="在包含它的视图 frame 内对齐的胶囊形状"
  value="https://developer.apple.com/documentation/swiftui/capsule"
/>
...
跟之前谈到的 [Circle](../circle) 和 [Ellipse](../ellipse) 视图一样，Capsule 也扩展了一个 `inset(by:)` 修饰器：
