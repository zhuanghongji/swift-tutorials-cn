...
[[fragment]] float4 fragment*shader(/* 其他参数 \_/ 常量 rasterization_rate_map_data &data [[buffer(0)]]) { float2 screen_coords = ...; rasterization_rate_map_decoder 映射（数据）； float2physical_coords = map.map_screen_to_physical_coords(screen_coords); ... }
