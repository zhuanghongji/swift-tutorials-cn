...
struct intersection_result
{
  ...
  // As of Metal 3.1, replaces instance_id and user_instance_id with   // an array if intersection_tags include instancing and
  // max_levels<Count>.
...
// Create an intersector that is specialized to support triangle and // world space data.
...
- 实例化
- 实例化、primitive_motion
- 实例化、instance_motion
- 实例化、primitive_motion、instance_motion
