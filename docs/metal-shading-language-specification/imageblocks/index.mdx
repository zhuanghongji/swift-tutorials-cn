...
图像块*切片*指的是图像块中的区域，其描述图像块中所有像素位置或线程的图像块数据结构中给定元素的值。imageblock 切片的存储类型必须与目标纹理的纹理格式兼容，如表 2.8 所示。
...
`浮点，半 R32Float、R16Float、R8Unorm、R8Snorm、R16Unorm、R16Snorm`
...
`rgba8unorm RGBA8Unorm，BGRA8Unorm`

`srgba8unorm RGBA8Unorm_sRGB，BGRA8Unorm_sRGB`

`rgba8snorm RGBA8Snorm，BGRA8Unorm`
