...
QuickTime 电影和 MPEG-4 视频文件可能包含提供标记媒体特征的轨道，以指示轨道媒体的用途、特征或功能。例如，将原始节目内容与视觉动作的附加叙述性描述混合在一起的音轨可能具有媒体特征 public.accessibility.describes-video ，以将其与存储在同一文件中的不包含附加叙述的其他音轨区分开来。
