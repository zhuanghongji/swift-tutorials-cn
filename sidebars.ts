 ...
 */
 ...
 type SidebarConfig = SidebarsConfig['']

const swiftSidebar: SidebarConfig = [
  {
    type: "category",
    label: "Swift",
    collapsible: false,
...
const swiftuiSidebar: SidebarConfig = [
  {
    type: "category",
    label: "SwiftUI",
    collapsible: false,
...
const swiftdataSidebar: SidebarConfig = [
  {
    type: "category",
    label: "SwiftData",
    collapsible: false,
...
const coregraphicsSidebar: SidebarConfig = [
  {
    type: "category",
    label: "Core Graphics",
    collapsible: false,
...
const chartsSidebar: SidebarConfig = [
  {
    type: "category",
    label: "Swift Charts",
    collapsible: false,
...
const metalSidebar: SidebarConfig = [
  {
    type: "category",
    label: "Metal",
    collapsible: false,
...
const metalkitSidebar: SidebarConfig = [
  {
    type: "category",
    label: "MetalKit",
    collapsible: false,
...
const metalprogrammingguideSidebar: SidebarConfig = [
  {
    type: "category",
    label: "Metal 编程指南",
    collapsible: false,
...
const metalshadinglanguagespecificationSidebar: SidebarConfig = [
  {
    type: "category",
...
const audiotoolboxSidebar: SidebarConfig = [
  {
    type: "category",
    label: "Audio Toolbox",
    collapsible: false,
...
const avfaudioSidebar: SidebarConfig = [
  {
    type: "category",
    label: "AVFAudio",
    collapsible: false,
...
const avfoundationSidebar: SidebarConfig = [
  {
    type: "category",
    label: "AVFoundation",
    collapsible: true,
    items: [
      {
        ...
        items: [
          ...
          "av-foundation/esseentials/exporting-video-to-alternative-formats/index",
          "av-foundation/esseentials/creating-images-from-a-video-asset/index",
          "av-foundation/esseentials/writing-fragmented-mpeg-4-files-for-http-live-streaming/index",
          "av-foundation/esseentials/tagging-media-with-video-color-information/index",
          "av-foundation/esseentials/evaluating-an-app-s-video-color/index",
          "av-foundation/esseentials/caption-authoring/index",
          "av-foundation/esseentials/configuring-your-app-for-media-playback/index",
          "av-foundation/esseentials/controlling-the-transport-behavior-of-a-player/index",
          "av-foundation/esseentials/supporting-coordinated-media-playback/index",
          "av-foundation/esseentials/monitoring-playback-progress-in-your-app/index",
